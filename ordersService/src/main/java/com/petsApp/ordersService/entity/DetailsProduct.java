...
public class DetailsProduct {
    ...
    private OrderReady orderReady;

    public DetailsProduct() {}

    public DetailsProduct(Long id, String name_product, String weight_product, Float price, Long stock, Float subtotal, OrderReady orderReady) {
        this.id = id;
    ...
    public void setOrderReady(OrderReady orderReady) {
        this.orderReady = orderReady;
    }
